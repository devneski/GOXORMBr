...
uses
  ...
  {$ENDIF EurekaLog}
  Vcl.Forms,
  Frm_MainServer in 'Frm_MainServer.pas' {FrmMainServer},
  xxxxxxxKernel.Request.Session in 'xxxxxxxKernel.Request.Session.pas',
  Core.Logtxt in 'Core.Logtxt.pas',
  Core.Database.Connection in 'Core.Database.Connection.pas',
  Core.Server.TokenClaim in 'Core.Server.TokenClaim.pas',
  Core.Database.Connection.Manager in 'Core.Database.Connection.Manager.pas',
  ...
  goxormbr.core.abstract.types in '..\..\..\GOX_ORMLibrary\GOX_Core\goxormbr.core.abstract.types.pas',
  goxormbr.engine.connection in '..\..\..\GOX_ORMLibrary\GOX_EngineConnection\goxormbr.engine.connection.pas',
  Api.Contacts in 'Api_Contacts\Api.Contacts.pas',
  Domain.Contacts in 'Domain_Contacts\Domain.Contacts.pas',
  ...
  Repository.Manager.db in '..\Common\Common_Repository\Repository.Manager.db.pas',
