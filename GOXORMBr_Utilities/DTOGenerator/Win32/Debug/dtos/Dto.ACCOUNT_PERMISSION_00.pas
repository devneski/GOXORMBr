unit Dto.ACCOUNT_PERMISSION_00;
...
type
  [Entity]
  [Table('ACCOUNT_PERMISSION_00', '')]
  [PrimaryKey('APE_ID', AutoInc, NoSort, False, 'Chave primária')]
  [Sequence('SEQ_APE_ID')]
  TDtoACCOUNT_PERMISSION_00 = class
  private
  ...
  public 
    { Public declarations } 
    const Table      = 'ACCOUNT_PERMISSION_00';
    const PrimaryKey = 'APE_ID';
    const Sequence   = 'SEQ_APE_ID';
...
initialization
  TRegisterClass.RegisterEntity(TDtoACCOUNT_PERMISSION_00)
