...
unit goxormbr.core.mapping.popular;
interface
uses
  DB,
  Classes,
...
function TMappingPopular.PopularLazy(ARttiType: TRttiType; var AFieldName: String): TLazyMapping;
var
  LField: TRttiField;
begin
  Result := nil;
...
function TMappingPopular.PopularPrimaryKeyColumns(ARttiType: TRttiType; AClass: TClass): TPrimaryKeyColumnsMapping;
var
