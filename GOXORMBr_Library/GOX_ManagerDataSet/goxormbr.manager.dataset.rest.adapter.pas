...
unit goxormbr.manager.dataset.rest.adapter;
...
type
  // M - Object M
  TGOXManagerDataSetAdapterRest<M: class, constructor> = class(TGOXManagerDataSetAdapterBase<M>)
  private
  ...
  protected
    ...
    procedure PopularDataSetOneToOne(const AObject: TObject; const AAssociation: TAssociationMapping); virtual; abstract;
    ...
    procedure DoBeforeCancel(DataSet: TDataSet); override;
    ...
    //
  public
    constructor Create(const AConnection: TGOXRESTConnection; ADataSet: TDataSet; APageSize: Integer; AMasterObject: TObject); overload; virtual;
    destructor Destroy; override;
    //
    function ResultParams: TParams; override;
    function AddPathParam(AValue: String):TGOXManagerDataSetAdapterBase<M>; override;
    function AddQueryParam(AKeyName, AValue: String):TGOXManagerDataSetAdapterBase<M>; override;
    function AddBodyParam(AValue: String):TGOXManagerDataSetAdapterBase<M>; override;
...
{ TGOXManagerDataSetAdapterRest<M> }

constructor TGOXManagerDataSetAdapterRest<M>.Create(const AConnection: TGOXRESTConnection; ADataSet: TDataSet; APageSize: Integer; AMasterObject: TObject);
begin
  inherited Create(ADataSet, APageSize, AMasterObject);
  FConnection := AConnection;
  FSession := TGOXManagerDatasetSessionRest<M>.Create(AConnection, Self, APageSize);
end;

destructor TGOXManagerDataSetAdapterRest<M>.Destroy;
begin
  FSession.Free;
  inherited;
end;

procedure TGOXManagerDataSetAdapterRest<M>.DeleteDataSetChilds;
var
...
function TGOXManagerDataSetAdapterRest<M>.AddBodyParam(AValue: String): TGOXManagerDataSetAdapterBase<M>;
begin
  Result := Self;
  FConnection.AddBodyParam(AValue);
end;

function TGOXManagerDataSetAdapterRest<M>.AddPathParam(AValue: String): TGOXManagerDataSetAdapterBase<M>;
begin
  Result := Self;
  FConnection.AddPathParam(AValue);
end;

function TGOXManagerDataSetAdapterRest<M>.AddQueryParam(AKeyName, AValue: String): TGOXManagerDataSetAdapterBase<M>;
begin
  Result := Self;
  FConnection.AddQueryParam(AKeyName,AValue);
end;

procedure TGOXManagerDataSetAdapterRest<M>.ApplyDeleter(const MaxErros: Integer);
var
  LObject: TObject;
begin
  inherited;
...
procedure TGOXManagerDataSetAdapterRest<M>.ApplyInserter(const MaxErros: Integer);
var
  LObject: TObject;
...
procedure TGOXManagerDataSetAdapterRest<M>.ApplyUpdater(const MaxErros: Integer);
var
  LObject: TObject;
...
procedure TGOXManagerDataSetAdapterRest<M>.DoAfterDelete(DataSet: TDataSet);
begin
...
procedure TGOXManagerDataSetAdapterRest<M>.DoBeforeCancel(DataSet: TDataSet);
begin
  inherited DoBeforeCancel(DataSet);
end;

procedure TGOXManagerDataSetAdapterRest<M>.DoBeforeDelete(DataSet: TDataSet);
var
  LObject: TObject;
begin
...
procedure TGOXManagerDataSetAdapterRest<M>.DoBeforePost(DataSet: TDataSet);
begin
...
procedure TGOXManagerDataSetAdapterRest<M>.ExecuteCheckNotNull;
var
...
procedure TGOXManagerDataSetAdapterRest<M>.PopularDataSet(const AObject: TObject);
begin
  FOrmDataSet.Append;
...
procedure TGOXManagerDataSetAdapterRest<M>.PopularDataSetList(const AObjectList: TObjectList<M>);
var
  LObject: M;
begin
...
procedure TGOXManagerDataSetAdapterRest<M>.PopularDataSetChilds(const AObject: TObject);
var
  LAssociations: TAssociationMappingList;
  LAssociation: TAssociationMapping;
...
procedure TGOXManagerDataSetAdapterRest<M>.PopularDataSetOneToMany(
  const AObjectList: TObjectList<TObject>);
var
  LDataSetChild: TGOXManagerDataSetAdapterRest<M>;
  LObjectChild: TObject;
begin
  ...
  begin
    ...
    LDataSetChild := TGOXManagerDataSetAdapterRest<M>(FMasterObject.Items[LObjectChild.ClassName]);
...
procedure TGOXManagerDataSetAdapterRest<M>.RefreshDataSetOneToOneChilds(AFieldName: string);
var
  LAssociations: TAssociationMappingList;
  LAssociation: TAssociationMapping;
  LDataSetChild: TGOXManagerDataSetAdapterBase<M>;
...
procedure TGOXManagerDataSetAdapterRest<M>.RefreshRecordInternal(const AObject: TObject);
var
  LChildDataSet: TGOXManagerDataSetAdapterBase<M>;
begin
  inherited;
...
function TGOXManagerDataSetAdapterRest<M>.ResultParams: TParams;
begin
  Result := FSession.ResultParams;
end;

procedure TGOXManagerDataSetAdapterRest<M>.SetAutoIncValueChilds;
var
  LAssociation: TAssociationMapping;
  LAssociations: TAssociationMappingList;
  LDataSetChild: TGOXManagerDataSetAdapterBase<M>;
...
procedure TGOXManagerDataSetAdapterRest<M>.SetMasterDataSetStateEdit;
var
  FOwner: TGOXManagerDataSetAdapterBase<M>;
begin
  if FOwnerMasterObject = nil then
    Exit;
  FOwner := TGOXManagerDataSetAdapterBase<M>(FOwnerMasterObject);
